...
const BALKAN_TOURS: TourRoute[] = [
  ...
  // ===== 5 ADDITIONAL ICONIC BALKAN TOUR ROUTES =====

  {
    id: 'slo-pohorje-gorice',
    name: 'Pohorje & Slovenske Gorice',
    nameEn: 'Pohorje & Slovenske Gorice Loop',
    country: 'SI',
    countryFlag: '🇸🇮',
    distance: 90,
    duration: 150,
    difficulty: 'medium',
    description: 'Ruta od Maribora čez Pohorje z razgledi na Ribniško jezero, nato skozi vinorodne Slovenske gorice do Lenarta in nazaj. Zelena narava, smučišče in vinogradi v eni vožnji!',
    highlights: ['Pohorje smučišče', 'Ribniško jezero', 'Arex hotel', 'Slovenske gorice vinogradi', 'Lenart', 'Sveti Miklavž', 'Mariborsko Pohorje'],
    waypoints: [
      { lat: 46.5547, lng: 15.6459, name: 'Maribor - center' },
      { lat: 46.5283, lng: 15.6317, name: 'Pohorje - Arex' },
      { lat: 46.5083, lng: 15.5850, name: 'Pohorje smučišče' },
      { lat: 46.4917, lng: 15.5450, name: 'Ribniško jezero' },
      { lat: 46.5233, lng: 15.5167, name: 'Sveta Areh' },
      { lat: 46.5667, lng: 15.5833, name: 'Ruško selo' },
      { lat: 46.5817, lng: 15.7200, name: 'Sveti Miklavž' },
      { lat: 46.5733, lng: 15.8100, name: 'Lenart' },
      { lat: 46.5450, lng: 15.8700, name: 'Slovenske gorice - vinogradi' },
      { lat: 46.5547, lng: 15.6459, name: 'Maribor (konec)' },
    ],
    bestSeason: 'April - Oktober',
    rating: 8.2,
    tags: ['ikonična', 'gora', 'jezero', 'vinogradi', 'zanka'],
    isIconic: true,
  },
  {
    id: 'hrv-peljesac-peninsula',
    name: 'Pelješac & Ston',
    nameEn: 'Pelješac Peninsula Loop',
    country: 'HR',
    countryFlag: '🇭🇷',
    distance: 130,
    duration: 210,
    difficulty: 'medium',
    description: 'Pelješki polotok — od znamenitih Stonskih zidov ("Kineski zid Evrope") čez vinograde Dingača do Orebića in Lovišta. Vinska in obalna ruta z osupljivimi razgledi na otoke!',
    highlights: ['Ston zidovi (Kineski zid Evrope)', 'Pelješki most', 'Vino Dingač', 'Orebić plaža', 'Lovište', 'Mali Ston - ostrige'],
    waypoints: [
      { lat: 42.9800, lng: 17.6978, name: 'Ston' },
      { lat: 42.9700, lng: 17.6750, name: 'Mali Ston - ostrige' },
      { lat: 42.9500, lng: 17.6200, name: 'Janjina' },
      { lat: 42.9200, lng: 17.5500, name: 'Trpanj' },
      { lat: 42.8850, lng: 17.4600, name: 'Orebić' },
      { lat: 42.8600, lng: 17.3800, name: 'Viganj - surf' },
      { lat: 42.8400, lng: 17.3000, name: 'Kuna Pelješka' },
      { lat: 42.8100, lng: 17.2200, name: 'Lovište' },
      { lat: 42.9200, lng: 17.5500, name: 'Trpanj (trajekt)' },
      { lat: 42.9800, lng: 17.6978, name: 'Ston (konec)' },
    ],
    bestSeason: 'Marec - November',
    rating: 8.8,
    tags: ['ikonična', 'obala', 'polotok', 'vino', 'zgodovina', 'zanka'],
    isIconic: true,
  },
  {
    id: 'bih-jajce-travnik',
    name: 'Jajce-Travnik zanka',
    nameEn: 'Jajce-Travnik Loop',
    country: 'BA',
    countryFlag: '🇧🇦',
    distance: 110,
    duration: 180,
    difficulty: 'hard',
    description: 'Bosanska zgodovinska zanka — od Jajca s slapom v središču mesta do Travnikove stare utrdbe in Vlašić planine. Zanimiva mešanica zgodovine, gora in osupljive narave!',
    highlights: ['Jajce slap v centru', 'Travnik stari grad', 'Vlašić planina', 'Plava voda', 'Bosanska kulinarika'],
    waypoints: [
      { lat: 44.3400, lng: 17.2700, name: 'Jajce' },
      { lat: 44.3430, lng: 17.2680, name: 'Jajce slap v centru' },
      { lat: 44.3100, lng: 17.2000, name: 'Banjalučka cesta' },
      { lat: 44.2300, lng: 17.4100, name: 'Travnik' },
      { lat: 44.2280, lng: 17.4150, name: 'Travnik stari grad' },
      { lat: 44.1800, lng: 17.5300, name: 'Vlašić planina' },
      { lat: 44.1700, lng: 17.5600, name: 'Vlašić - vrh' },
      { lat: 44.1500, lng: 17.5000, name: 'Plava voda' },
      { lat: 44.2200, lng: 17.3800, name: 'Turbe' },
      { lat: 44.3400, lng: 17.2700, name: 'Jajce (konec)' },
    ],
    bestSeason: 'Maj - Oktober',
    rating: 8.5,
    tags: ['ikonična', 'zgodovina', 'slap', 'planina', 'utrdba', 'zanka'],
    isIconic: true,
  },
  {
    id: 'srb-zlatibor-tara',
    name: 'Zlatibor & Tara',
    nameEn: 'Zlatibor & Tara NP Loop',
    country: 'RS',
    countryFlag: '🇷🇸',
    distance: 140,
    duration: 240,
    difficulty: 'medium',
    description: 'Srbska gorska ruta — od Užica na Zlatibor, čez Šargansko osmico in Kusturičev Drvengrad do Narodnega parka Tara in Bajine Bašte. Kultura, narava in legendarna ozka proga!',
    highlights: ['Zlatibor planina', 'Šarganska osmica (muzej)', 'Drvengrad (Kusturica)', 'Tara NP', 'Rača manastir', 'Bajina Bašta'],
    waypoints: [
      { lat: 43.8586, lng: 19.8487, name: 'Užice' },
      { lat: 43.7278, lng: 19.7233, name: 'Zlatibor' },
      { lat: 43.7133, lng: 19.6583, name: 'Šarganska osmica' },
      { lat: 43.7233, lng: 19.6233, name: 'Mokra Gora' },
      { lat: 43.7383, lng: 19.5767, name: 'Mećavnik (Drvengrad)' },
      { lat: 43.8500, lng: 19.5300, name: 'Tara NP - Mitrovac' },
      { lat: 43.8600, lng: 19.4833, name: 'Banjska stena razgled' },
      { lat: 43.9000, lng: 19.4500, name: 'Rača manastir' },
      { lat: 43.9550, lng: 19.5617, name: 'Bajina Bašta' },
      { lat: 43.8586, lng: 19.8487, name: 'Užice (konec)' },
    ],
    bestSeason: 'Maj - Oktober',
    rating: 9.0,
    tags: ['ikonična', 'planina', 'narodni park', 'muzej', 'manastir', 'zanka'],
    isIconic: true,
  },
  {
    id: 'mkd-ohrid-lake',
    name: 'Ohridsko jezero',
    nameEn: 'Ohrid Lake Loop',
    country: 'MK',
    countryFlag: '🇲🇰',
    distance: 120,
    duration: 180,
    difficulty: 'easy',
    description: 'UNESCO Ohridsko jezero — od Ohrida do samostana Sveti Naum, čez Strugo in Vevčanske izvire. Sproščujoča obalna ruta z zgodovino, poezijo in kristalno čisto vodo!',
    highlights: ['Ohrid jezero (UNESCO)', 'Sveti Naum samostan', 'Struga (poezija)', 'Vevčani izviri', 'Ribarsko selo', 'Stari most Struga'],
    waypoints: [
      { lat: 41.1231, lng: 20.8016, name: 'Ohrid' },
      { lat: 41.1100, lng: 20.7600, name: 'Ohrid - staro mesto' },
      { lat: 41.0900, lng: 20.7400, name: 'Ohrid - Samuilova trdnjava' },
      { lat: 41.0400, lng: 20.7400, name: 'Ribarsko selo' },
      { lat: 40.9500, lng: 20.7400, name: 'Sveti Naum samostan' },
      { lat: 41.0200, lng: 20.6800, name: 'Radolišta' },
      { lat: 41.1780, lng: 20.6800, name: 'Struga' },
      { lat: 41.1900, lng: 20.5800, name: 'Vevčani izviri' },
      { lat: 41.1500, lng: 20.6500, name: 'Struga - stari most' },
      { lat: 41.1231, lng: 20.8016, name: 'Ohrid (konec)' },
    ],
    bestSeason: 'April - Oktober',
    rating: 9.3,
    tags: ['ikonična', 'jezero', 'UNESCO', 'samostan', 'obala', 'sproščena'],
    isIconic: true,
  },

  // ===== 5 MORE ICONIC BALKAN TOUR ROUTES (Task 2) =====

  {
    id: 'hrv-peljesac-peninsula-loop',
    ...
    duration: 240,
    difficulty: 'medium',
    description: 'Pelješki polotok — od znamenitih Stonskih zidov ("Kineski zid Evrope") čez vinorodni Dingač do Orebića in Lovišta na koncu polotoka. Obalna ruta z osupljivimi razgledi na otoke in Jonsko morje!',
    highlights: ['Stonski zidovi (Kineski zid Evrope)', 'Vino Dingač', 'Orebić plaža', 'Lovište - konec polotoka', 'Mali Ston - ostrige', 'Obalni razgledi na Korčulo'],
    waypoints: [
      { lat: 42.6515, lng: 17.6965, name: 'Ston' },
      { lat: 42.6494, lng: 17.6780, name: 'Mali Ston - ostrige' },
      { lat: 42.6900, lng: 17.6200, name: 'Zaton Doli' },
      { lat: 42.7800, lng: 17.4800, name: 'Podobuće' },
      { lat: 42.9215, lng: 17.3885, name: 'Dingač - razgled' },
      { lat: 42.9350, lng: 17.3820, name: 'Trstenik' },
      { lat: 42.9815, lng: 17.1880, name: 'Orebić' },
      { lat: 43.0000, lng: 17.1500, name: 'Viganj - surf' },
      { lat: 43.0300, lng: 17.1200, name: 'Nakovana' },
      { lat: 43.0535, lng: 17.1150, name: 'Lovište' },
      { lat: 42.9815, lng: 17.1880, name: 'Orebić (povratek)' },
      { lat: 42.6515, lng: 17.6965, name: 'Ston (konec)' },
    ],
    bestSeason: 'Marec - November',
    rating: 8.8,
    tags: ['ikonična', 'obala', 'polotok', 'vino', 'zgodovina', 'zanka'],
  ...
  {
    id: 'bih-cabulja-prenj-loop',
    name: 'Čabulja-Prenj gorska zanka',
    nameEn: 'Čabulja-Prenj Mountain Loop',
    country: 'BA',
    countryFlag: '🇧🇦',
    distance: 110,
    duration: 210,
    difficulty: 'hard',
    description: 'Herzegovska gorska zanka — od Mostarja ob izviru Bune v Blagaj, čez Čabulja prelaz in Rujnište pod Prenjem, do Konjica in Jablanice ob Neretvi. Krš, gore in reka v eni vožnji!',
    highlights: ['Blagaj - izvir Bune', 'Čabulja prelaz', 'Prenj gora (2155m)', 'Rujnište planina', 'Konjic - staro mesto', 'Neretva dolina', 'Jablanica - bitka'],
    waypoints: [
      { lat: 43.3438, lng: 17.8078, name: 'Mostar' },
      { lat: 43.2588, lng: 17.8965, name: 'Blagaj' },
      { lat: 43.2500, lng: 17.9000, name: 'Izvir Bune - tekija' },
      { lat: 43.3200, lng: 17.7500, name: 'Podveležje' },
      { lat: 43.3820, lng: 17.6520, name: 'Čabulja prelaz' },
      { lat: 43.4300, lng: 17.6800, name: 'Drežnica' },
      { lat: 43.5150, lng: 17.6350, name: 'Rujnište' },
      { lat: 43.5500, lng: 17.7000, name: 'Prenj - izhodišče' },
      { lat: 43.6527, lng: 17.9570, name: 'Konjic' },
      { lat: 43.6627, lng: 17.8127, name: 'Jablanica' },
      { lat: 43.5000, lng: 17.8500, name: 'Salakovac jezero' },
      { lat: 43.3438, lng: 17.8078, name: 'Mostar (konec)' },
    ],
    bestSeason: 'Maj - Oktober',
    rating: 9.0,
    tags: ['ikonična', 'gora', 'krš', 'reka', 'prelaz', 'zanka'],
    isIconic: true,
  },
  {
    id: 'mkd-mavrovo-debar-canyon',
    name: 'Mavrovo-Debar soteska',
    nameEn: 'Mavrovo-Debar Canyon Route',
    country: 'MK',
    countryFlag: '🇲🇰',
    distance: 120,
    duration: 210,
    difficulty: 'hard',
    description: 'Makedonska gorsko-soteska ruta — od Skopja čez Tetovo in Gostivar do Mavrovskega jezera, nato v globoko Radiško sotesko in Debar. Divja narava, globoka soteska in samotni manastir!',
    highlights: ['Mavrovsko jezero', 'Radiška soteska', 'Mavrovo manastir', 'Debar - orientalsko mesto', 'Gostivar bazar', 'Globoka soteska Radike'],
    waypoints: [
      { lat: 41.9973, lng: 21.4280, name: 'Skopje' },
      { lat: 42.0100, lng: 20.9715, name: 'Tetovo' },
      { lat: 41.9500, lng: 20.9300, name: 'Tetovo - Šare planine razgled' },
      { lat: 41.8038, lng: 20.9085, name: 'Gostivar' },
      { lat: 41.7300, lng: 20.8200, name: 'Mavrovo - cesta ob jezeru' },
      { lat: 41.6640, lng: 20.7400, name: 'Mavrovsko jezero' },
      { lat: 41.6500, lng: 20.7200, name: 'Mavrovo manastir' },
      { lat: 41.5900, lng: 20.6200, name: 'Radiška soteska' },
      { lat: 41.5230, lng: 20.5250, name: 'Debar' },
      { lat: 41.6200, lng: 20.6800, name: 'Vrben' },
      { lat: 41.8038, lng: 20.9085, name: 'Gostivar (povratek)' },
      { lat: 41.9973, lng: 21.4280, name: 'Skopje (konec)' },
    ],
    bestSeason: 'Maj - Oktober',
    rating: 8.9,
    tags: ['ikonična', 'soteska', 'jezero', 'manastir', 'gora', 'zanka'],
    isIconic: true,
  },
  {
    id: 'srb-zlatibor-tara-np',
    name: 'Zlatibor-Tara narodni park',
    nameEn: 'Zlatibor-Tara National Park',
    country: 'RS',
    countryFlag: '🇷🇸',
    distance: 140,
    duration: 270,
    difficulty: 'medium',
    description: 'Srbska gorska ruta — od Užica na Zlatibor, čez Mokro Goro in Kusturičev Mećavnik (Drvengrad) do Narodnega parka Tara ob reki Drini. Kultura, narava in legendarna reka v eni vožnji!',
    highlights: ['Zlatibor planina', 'Mokra Gora - ozka proga', 'Mećavnik (Kustendorf)', 'Tara narodni park', 'Reka Drina', 'Bajina Bašta - stari most', 'Banjska stena razgled'],
    waypoints: [
      { lat: 43.8575, lng: 19.8453, name: 'Užice' },
      { lat: 43.7275, lng: 19.7135, name: 'Zlatibor' },
      { lat: 43.7200, lng: 19.6800, name: 'Sirogojno - muzej na prostem' },
      { lat: 43.7880, lng: 19.5580, name: 'Mokra Gora' },
      { lat: 43.7930, lng: 19.5540, name: 'Mećavnik (Kustendorf)' },
      { lat: 43.8200, lng: 19.5000, name: 'Kremna' },
      { lat: 43.8970, lng: 19.4530, name: 'Tara NP' },
      { lat: 43.8800, lng: 19.4600, name: 'Mitrovac' },
      { lat: 43.8600, lng: 19.4833, name: 'Banjska stena razgled' },
      { lat: 43.9755, lng: 19.4725, name: 'Bajina Bašta' },
      { lat: 43.9200, lng: 19.5500, name: 'Rogačica' },
      { lat: 43.8575, lng: 19.8453, name: 'Užice (konec)' },
    ],
    bestSeason: 'Maj - Oktober',
    rating: 9.1,
    tags: ['ikonična', 'planina', 'narodni park', 'reka', 'muzej', 'zanka'],
    isIconic: true,
  },
  {
    id: 'grc-meteora-pindus',
    name: 'Meteora-Pind gorska ruta',
    nameEn: 'Meteora-Pindus Mountains',
    country: 'GR',
    countryFlag: '🇬🇷',
    distance: 150,
    duration: 300,
    difficulty: 'hard',
    description: 'Grška kulturno-gorska ruta — od Kalabake do samostanov na Meteorskih skalah, čez Trikalo in Pind gorski prelaz do Metsova in Janine z jezerom. Samostani na skalah, gorski prelaz in jezero!',
    highlights: ['Meteora - samostani na skalah (UNESCO)', 'Veliki Meteoron', 'Pind gorski prelaz', 'Metsovo - sir in vino', 'Janinsko jezero', 'Janina - stari grad', 'Kalabaka - skalni stebri'],
    waypoints: [
      { lat: 39.7060, lng: 21.6270, name: 'Kalabaka' },
      { lat: 39.7210, lng: 21.6300, name: 'Meteora - samostani' },
      { lat: 39.7250, lng: 21.6350, name: 'Veliki Meteoron' },
      { lat: 39.7150, lng: 21.6200, name: 'Roussanou samostan' },
      { lat: 39.5560, lng: 21.7670, name: 'Trikala' },
      { lat: 39.6000, lng: 21.5000, name: 'Porta Panagia' },
      { lat: 39.6400, lng: 21.1900, name: 'Pind gorski prelaz' },
      { lat: 39.6940, lng: 21.1850, name: 'Metsovo' },
      { lat: 39.6800, lng: 21.0500, name: 'Katara prelaz' },
      { lat: 39.6750, lng: 20.8550, name: 'Janina' },
      { lat: 39.6800, lng: 20.8300, name: 'Janinsko jezero' },
      { lat: 39.7060, lng: 21.6270, name: 'Kalabaka (konec)' },
    ],
    bestSeason: 'April - Oktober',
    rating: 9.5,
    tags: ['ikonična', 'samostan', 'gora', 'prelaz', 'jezero', 'UNESCO', 'zanka'],
    isIconic: true,
  },
]
